...
export default function GraphView({
  ...
  // Nodes identical on both sides — dimmed in every pane.
  const common = useMemo(
    () => (threeWayMode ? commonGuids(oursText, theirsText) : new Set<string>()),
    [threeWayMode, oursText, theirsText],
  );

  // The merged "result" graph text, rebuilt whenever a pick changes.
  ...
  // Real conflicts = conflict status AND not agreed/common.
...
// Floating O/T/Skip badge over each conflict node in the result pane.
