...
export default function GraphView({
  ...
  const winner = graphWinner(change, selections?.get(activeGraph));
    ...
    <div className={styles.container}>
      <div className={styles.toolbar}>
        ...
        {threeWayMode && change === "both" && onSelectionChange && (
          <span className={styles.graphPick}>
            <span className={styles.pickTag}>changed on both - keep:</span>
        ...
        {threeWayMode && change === "oursOnly" && <span className={styles.note}>changed in Ours, kept</span>}
        {threeWayMode && change === "theirsOnly" && <span className={styles.note}>changed in Theirs, taken</span>}
        {threeWayMode && change === "unchanged" && <span className={`${styles.note} ${styles.muted}`}>unchanged</span>}
      </div>
